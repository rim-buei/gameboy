...
pub fn exec_prefix_cb(opcode: u8, reg: &mut Registers, ram: &mut Ram) -> (u8, u8) {
    ...
    match opcode {
        ...
        0x46 => p.bit8(0, Address::HL).r(2, 16), // [BIT 0,(HL)] [2  16] [Z 0 1 -]
        ...
        0x4E => p.bit8(1, Address::HL).r(2, 16), // [BIT 1,(HL)] [2  16] [Z 0 1 -]
        ...
        0x56 => p.bit8(2, Address::HL).r(2, 16), // [BIT 2,(HL)] [2  16] [Z 0 1 -]
        ...
        0x5E => p.bit8(3, Address::HL).r(2, 16), // [BIT 3,(HL)] [2  16] [Z 0 1 -]
        ...
        0x66 => p.bit8(4, Address::HL).r(2, 16), // [BIT 4,(HL)] [2  16] [Z 0 1 -]
        ...
        0x6E => p.bit8(5, Address::HL).r(2, 16), // [BIT 5,(HL)] [2  16] [Z 0 1 -]
        ...
        0x76 => p.bit8(6, Address::HL).r(2, 16), // [BIT 6,(HL)] [2  16] [Z 0 1 -]
        ...
        0x7E => p.bit8(7, Address::HL).r(2, 16), // [BIT 7,(HL)] [2  16] [Z 0 1 -]
