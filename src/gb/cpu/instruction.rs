...
use super::register::Register16;
use super::register::Register8;
...
pub fn exec(opcode: u8, reg: &mut Registers, ram: &mut Ram) -> (u8, u8) {
    match opcode {
        ...
        0x26 => ld_r8_n8(reg, ram, Register8::H),          // [LD H,d8] [2  8] [- - - -]
        ...
        0x2E => ld_r8_n8(reg, ram, Register8::L),          // [LD L,d8] [2  8] [- - - -]
        ...
        0x42 => ld_r8_r8(reg, Register8::B, Register8::D), // [LD B,D] [1  4] [- - - -]
        0x43 => ld_r8_r8(reg, Register8::B, Register8::E), // [LD B,E] [1  4] [- - - -]
        0x44 => ld_r8_r8(reg, Register8::B, Register8::H), // [LD B,H] [1  4] [- - - -]
        0x45 => ld_r8_r8(reg, Register8::B, Register8::L), // [LD B,L] [1  4] [- - - -]
        0x46 => (0, 0),                                    // TODO: [LD B,(HL)] [1  8] [- - - -]
        0x47 => ld_r8_r8(reg, Register8::B, Register8::A), // [LD B,A] [1  4] [- - - -]
        0x48 => ld_r8_r8(reg, Register8::C, Register8::B), // [LD C,B] [1  4] [- - - -]
        0x49 => ld_r8_r8(reg, Register8::C, Register8::C), // [LD C,C] [1  4] [- - - -]
        0x4A => ld_r8_r8(reg, Register8::C, Register8::D), // [LD C,D] [1  4] [- - - -]
        0x4B => ld_r8_r8(reg, Register8::C, Register8::E), // [LD C,E] [1  4] [- - - -]
        0x4C => ld_r8_r8(reg, Register8::C, Register8::H), // [LD C,H] [1  4] [- - - -]
        0x4D => ld_r8_r8(reg, Register8::C, Register8::L), // [LD C,L] [1  4] [- - - -]
        0x4E => (0, 0),                                    // TODO: [LD C,(HL)] [1  8] [- - - -]
        0x4F => ld_r8_r8(reg, Register8::C, Register8::A), // [LD C,A] [1  4] [- - - -]
        0x50 => ld_r8_r8(reg, Register8::D, Register8::B), // [LD D,B] [1  4] [- - - -]
        0x51 => ld_r8_r8(reg, Register8::D, Register8::C), // [LD D,C] [1  4] [- - - -]
        0x52 => ld_r8_r8(reg, Register8::D, Register8::D), // [LD D,D] [1  4] [- - - -]
        0x53 => ld_r8_r8(reg, Register8::D, Register8::E), // [LD D,E] [1  4] [- - - -]
        0x54 => ld_r8_r8(reg, Register8::D, Register8::H), // [LD D,H] [1  4] [- - - -]
        0x55 => ld_r8_r8(reg, Register8::D, Register8::L), // [LD D,L] [1  4] [- - - -]
        0x56 => (0, 0),                                    // TODO: [LD D,(HL)] [1  8] [- - - -]
        0x57 => ld_r8_r8(reg, Register8::D, Register8::A), // [LD D,A] [1  4] [- - - -]
        0x58 => ld_r8_r8(reg, Register8::E, Register8::B), // [LD E,B] [1  4] [- - - -]
        0x59 => ld_r8_r8(reg, Register8::E, Register8::C), // [LD E,C] [1  4] [- - - -]
        0x5A => ld_r8_r8(reg, Register8::E, Register8::D), // [LD E,D] [1  4] [- - - -]
        0x5B => ld_r8_r8(reg, Register8::E, Register8::E), // [LD E,E] [1  4] [- - - -]
        0x5C => ld_r8_r8(reg, Register8::E, Register8::H), // [LD E,H] [1  4] [- - - -]
        0x5D => ld_r8_r8(reg, Register8::E, Register8::L), // [LD E,L] [1  4] [- - - -]
        0x5E => (0, 0),                                    // TODO: [LD E,(HL)] [1  8] [- - - -]
        0x5F => ld_r8_r8(reg, Register8::E, Register8::A), // [LD E,A] [1  4] [- - - -]
        0x60 => ld_r8_r8(reg, Register8::H, Register8::B), // [LD H,B] [1  4] [- - - -]
        0x61 => ld_r8_r8(reg, Register8::H, Register8::C), // [LD H,C] [1  4] [- - - -]
        0x62 => ld_r8_r8(reg, Register8::H, Register8::D), // [LD H,D] [1  4] [- - - -]
        0x63 => ld_r8_r8(reg, Register8::H, Register8::E), // [LD H,E] [1  4] [- - - -]
        0x64 => ld_r8_r8(reg, Register8::H, Register8::H), // [LD H,H] [1  4] [- - - -]
        0x65 => ld_r8_r8(reg, Register8::H, Register8::L), // [LD H,L] [1  4] [- - - -]
        0x66 => (0, 0),                                    // TODO: [LD H,(HL)] [1  8] [- - - -]
        0x67 => ld_r8_r8(reg, Register8::H, Register8::A), // [LD H,A] [1  4] [- - - -]
        0x68 => ld_r8_r8(reg, Register8::L, Register8::B), // [LD L,B] [1  4] [- - - -]
        0x69 => ld_r8_r8(reg, Register8::L, Register8::C), // [LD L,C] [1  4] [- - - -]
        0x6A => ld_r8_r8(reg, Register8::L, Register8::D), // [LD L,D] [1  4] [- - - -]
        0x6B => ld_r8_r8(reg, Register8::L, Register8::E), // [LD L,E] [1  4] [- - - -]
        0x6C => ld_r8_r8(reg, Register8::L, Register8::H), // [LD L,H] [1  4] [- - - -]
        0x6D => ld_r8_r8(reg, Register8::L, Register8::L), // [LD L,L] [1  4] [- - - -]
        0x6E => (0, 0),                                    // TODO: [LD L,(HL)] [1  8] [- - - -]
        0x6F => ld_r8_r8(reg, Register8::L, Register8::A), // [LD L,A] [1  4] [- - - -]
        0x70 => (0, 0),                                    // TODO: [LD (HL),B] [1  8] [- - - -]
        0x71 => (0, 0),                                    // TODO: [LD (HL),C] [1  8] [- - - -]
        0x72 => (0, 0),                                    // TODO: [LD (HL),D] [1  8] [- - - -]
        0x73 => (0, 0),                                    // TODO: [LD (HL),E] [1  8] [- - - -]
        0x74 => (0, 0),                                    // TODO: [LD (HL),H] [1  8] [- - - -]
        0x75 => (0, 0),                                    // TODO: [LD (HL),L] [1  8] [- - - -]
        0x76 => (0, 0),                                    // TODO: [HALT] [1  4] [- - - -]
        0x77 => (0, 0),                                    // TODO: [LD (HL),A] [1  8] [- - - -]
        0x78 => ld_r8_r8(reg, Register8::A, Register8::B), // [LD A,B] [1  4] [- - - -]
        0x79 => ld_r8_r8(reg, Register8::A, Register8::C), // [LD A,C] [1  4] [- - - -]
        0x7A => ld_r8_r8(reg, Register8::A, Register8::D), // [LD A,D] [1  4] [- - - -]
        0x7B => ld_r8_r8(reg, Register8::A, Register8::E), // [LD A,E] [1  4] [- - - -]
        0x7C => ld_r8_r8(reg, Register8::A, Register8::H), // [LD A,H] [1  4] [- - - -]
        0x7D => ld_r8_r8(reg, Register8::A, Register8::L), // [LD A,L] [1  4] [- - - -]
        0x7E => (0, 0),                                    // TODO: [LD A,(HL)] [1  8] [- - - -]
        0x7F => ld_r8_r8(reg, Register8::A, Register8::A), // [LD A,A] [1  4] [- - - -]
        0x80 => (0, 0),                                    // TODO: [ADD A,B] [1  4] [Z 0 H C]
        0x81 => (0, 0),                                    // TODO: [ADD A,C] [1  4] [Z 0 H C]
        0x82 => (0, 0),                                    // TODO: [ADD A,D] [1  4] [Z 0 H C]
        0x83 => (0, 0),                                    // TODO: [ADD A,E] [1  4] [Z 0 H C]
        0x84 => (0, 0),                                    // TODO: [ADD A,H] [1  4] [Z 0 H C]
        0x85 => (0, 0),                                    // TODO: [ADD A,L] [1  4] [Z 0 H C]
        0x86 => (0, 0),                                    // TODO: [ADD A,(HL)] [1  8] [Z 0 H C]
        0x87 => (0, 0),                                    // TODO: [ADD A,A] [1  4] [Z 0 H C]
        ...
        0xC6 => (0, 0), // TODO: [ADD A,d8] [2  8] [Z 0 H C]
...
fn ld_r8_n8(reg: &mut Registers, ram: &mut Ram, lhs: Register8) -> (u8, u8) {
    reg.set8(lhs, ram.read(reg.get_PC() + 1));
    (2, 8)
}

fn ld_r8_r8(reg: &mut Registers, lhs: Register8, rhs: Register8) -> (u8, u8) {
...
mod tests {
    ...
    fn test_ld_r8_n8() {
        ...
        ld_r8_n8(&mut reg, &mut ram, Register8::B);
        assert_eq!(0xAA, reg.get8(Register8::B));
    }

    #[test]
    fn test_ld_r8_r8() {
        let mut reg = Registers::new();
        reg.set8(Register8::B, 0xAA);

        ld_r8_r8(&mut reg, Register8::C, Register8::B);
        assert_eq!(0xAA, reg.get8(Register8::B));
        assert_eq!(0xAA, reg.get8(Register8::C));
    }
}
