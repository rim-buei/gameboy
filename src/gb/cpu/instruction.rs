...
pub fn exec(opcode: u8, reg: &mut Registers, ram: &mut Ram) -> (u8, u8) {
    match opcode {
        ...
        0x40 => (0, 0), // TODO: [LD B,B] [1  4] [- - - -]
        0x41 => (0, 0), // TODO: [LD B,C] [1  4] [- - - -]
        0x42 => (0, 0), // TODO: [LD B,D] [1  4] [- - - -]
        0x43 => (0, 0), // TODO: [LD B,E] [1  4] [- - - -]
        0x44 => (0, 0), // TODO: [LD B,H] [1  4] [- - - -]
        0x45 => (0, 0), // TODO: [LD B,L] [1  4] [- - - -]
        0x46 => (0, 0), // TODO: [LD B,(HL)] [1  8] [- - - -]
        0x47 => (0, 0), // TODO: [LD B,A] [1  4] [- - - -]
        0x48 => (0, 0), // TODO: [LD C,B] [1  4] [- - - -]
        0x49 => (0, 0), // TODO: [LD C,C] [1  4] [- - - -]
        0x4A => (0, 0), // TODO: [LD C,D] [1  4] [- - - -]
        0x4B => (0, 0), // TODO: [LD C,E] [1  4] [- - - -]
        0x4C => (0, 0), // TODO: [LD C,H] [1  4] [- - - -]
        0x4D => (0, 0), // TODO: [LD C,L] [1  4] [- - - -]
        0x4E => (0, 0), // TODO: [LD C,(HL)] [1  8] [- - - -]
        0x4F => (0, 0), // TODO: [LD C,A] [1  4] [- - - -]
        0x50 => (0, 0), // TODO: [LD D,B] [1  4] [- - - -]
        0x51 => (0, 0), // TODO: [LD D,C] [1  4] [- - - -]
        0x52 => (0, 0), // TODO: [LD D,D] [1  4] [- - - -]
        0x53 => (0, 0), // TODO: [LD D,E] [1  4] [- - - -]
        0x54 => (0, 0), // TODO: [LD D,H] [1  4] [- - - -]
        0x55 => (0, 0), // TODO: [LD D,L] [1  4] [- - - -]
        0x56 => (0, 0), // TODO: [LD D,(HL)] [1  8] [- - - -]
        0x57 => (0, 0), // TODO: [LD D,A] [1  4] [- - - -]
        0x58 => (0, 0), // TODO: [LD E,B] [1  4] [- - - -]
        0x59 => (0, 0), // TODO: [LD E,C] [1  4] [- - - -]
        0x5A => (0, 0), // TODO: [LD E,D] [1  4] [- - - -]
        0x5B => (0, 0), // TODO: [LD E,E] [1  4] [- - - -]
        0x5C => (0, 0), // TODO: [LD E,H] [1  4] [- - - -]
        0x5D => (0, 0), // TODO: [LD E,L] [1  4] [- - - -]
        0x5E => (0, 0), // TODO: [LD E,(HL)] [1  8] [- - - -]
        0x5F => (0, 0), // TODO: [LD E,A] [1  4] [- - - -]
        0x60 => (0, 0), // TODO: [LD H,B] [1  4] [- - - -]
        0x61 => (0, 0), // TODO: [LD H,C] [1  4] [- - - -]
        0x62 => (0, 0), // TODO: [LD H,D] [1  4] [- - - -]
        0x63 => (0, 0), // TODO: [LD H,E] [1  4] [- - - -]
        0x64 => (0, 0), // TODO: [LD H,H] [1  4] [- - - -]
        0x65 => (0, 0), // TODO: [LD H,L] [1  4] [- - - -]
        0x66 => (0, 0), // TODO: [LD H,(HL)] [1  8] [- - - -]
        0x67 => (0, 0), // TODO: [LD H,A] [1  4] [- - - -]
        0x68 => (0, 0), // TODO: [LD L,B] [1  4] [- - - -]
        0x69 => (0, 0), // TODO: [LD L,C] [1  4] [- - - -]
        0x6A => (0, 0), // TODO: [LD L,D] [1  4] [- - - -]
        0x6B => (0, 0), // TODO: [LD L,E] [1  4] [- - - -]
        0x6C => (0, 0), // TODO: [LD L,H] [1  4] [- - - -]
        0x6D => (0, 0), // TODO: [LD L,L] [1  4] [- - - -]
        0x6E => (0, 0), // TODO: [LD L,(HL)] [1  8] [- - - -]
        0x6F => (0, 0), // TODO: [LD L,A] [1  4] [- - - -]
        ...
        0x78 => (0, 0), // TODO: [LD A,B] [1  4] [- - - -]
        0x79 => (0, 0), // TODO: [LD A,C] [1  4] [- - - -]
        0x7A => (0, 0), // TODO: [LD A,D] [1  4] [- - - -]
        0x7B => (0, 0), // TODO: [LD A,E] [1  4] [- - - -]
        0x7C => (0, 0), // TODO: [LD A,H] [1  4] [- - - -]
        0x7D => (0, 0), // TODO: [LD A,L] [1  4] [- - - -]
        0x7E => (0, 0), // TODO: [LD A,(HL)] [1  8] [- - - -]
        0x7F => (0, 0), // TODO: [LD A,A] [1  4] [- - - -]
...
fn ld_r8_r8(lhs: Register8, rhs: Register8) {}

fn ld_r8_n8(reg: &mut Registers, ram: &mut Ram, lhs: Register8) {
